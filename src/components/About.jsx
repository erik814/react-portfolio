        ...
        return(
            <div className="about-container">
                <div className="about-text-container">
                    <h2>About Me</h2>
                    <p>Hi there! My name is Erik Neafus and I'm a web developer based in the Twin Cities. I recently graduated from the University of Minnesota coding bootcamp where I learned the latest web development technologies and gained hands-on experience building web applications.</p>
